  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 mt-10">
        <div className="flex flex-col justify-center items-start px-8 sm:px-23 gap-8">
        ...
        <div className=" sm:flex-wrap gap-x-2 justify-end items-center px-20 hidden sm:flex">
